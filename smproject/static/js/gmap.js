...
+'   </span>'
+'</div>'
+'<p class="gmap-open"><a href="https://www.google.com/maps/@-37.824812,144.965981,14z?hl=ru-RU" target="_blank">Open on Google Maps</a></p></div>';var infowindow=new google.maps.InfoWindow({content:contentString,});var image='';var myLatLng=new google.maps.LatLng(43.5015700,20.1276913);var beachMarker=new google.maps.Marker({position:mapLocation,map:map,icon:'images/map_marker.png'});}
